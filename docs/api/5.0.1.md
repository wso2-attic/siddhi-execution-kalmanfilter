...
### kalmanFilter *<a target="_blank" href="http://siddhi.io/en/v5.1/docs/query-guide/#function">(Function)</a>*
...
```
<DOUBLE> kf:kalmanFilter(<DOUBLE> measured.value)
<DOUBLE> kf:kalmanFilter(<DOUBLE> measured.value, <DOUBLE> measurement.noise.sd)
...
<table>
    ...
    <tr>
        ...
        <td style="vertical-align: top">time: timestampInMilliseconds()</td>
